...
public class UserDeniedHandler implements AccessDeniedHandler {
	...
	public void handle(HttpServletRequest request, HttpServletResponse res,
		...
		/*
		 * request.setAttribute("errMsg",ade.getMessage()); request.getrequestuestDispatcher(
		 * "/WEB-INF/jsp/egovframework/example/sample/errorPage.jsp").forward(request, res);
		 */
		...
		if(ajaxHeader == null) {
			...
			request.setAttribute(("errormsg"), ade);
			request.getRequestDispatcher(errorPage).forward(request, res);
